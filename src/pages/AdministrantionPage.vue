  ...
  <div class="admin-container">
    ...
    <div class="sidebar" :class="{ 'sidebar-open': isSidebarOpen }">
      ...
      <ul class="sidebar-menu">
        <li
          @click="navigateTo('booking-report')"
          :class="{ active: currentRoute === 'booking-report' }"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
        ...
        <li
          @click="navigateTo('revenue-report')"
          :class="{ active: currentRoute === 'revenue-report' }"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
        ...
        <li
          @click="navigateTo('stadiums')"
          :class="{ active: currentRoute === 'stadiums' }"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
        ...
        <li
          @click="navigateTo('manage-complaints')"
          :class="{ active: currentRoute === 'manage-complaints' }"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
        ...
        <li
          @click="navigateTo('pending-stadium')"
          :class="{ active: currentRoute === 'pending-stadium' }"
        >
          <span>Pending Stadium</span>
        </li>
  ...
  setup() {
    ...
    const getPageTitle = () => {
      switch (route.name) {
        ...
        case "pending-stadium":
          return "Quan lý sân chờ duyệt";
        default:
